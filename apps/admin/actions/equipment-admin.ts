...
// The public rentals catalog (apps/marketing's /rentals) lives in a separate
...
// on-demand-revalidation trigger to pick up equipment changes before its
// ISR window naturally expires; tracked as an open item, not solved here.
