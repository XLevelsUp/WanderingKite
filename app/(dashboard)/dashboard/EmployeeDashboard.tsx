      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="col-span-1">
          ...
          <CardContent className="space-y-3">
            ...
            <Link href="/dashboard/attendance" className="flex items-center justify-between p-3 rounded-xl border border-border hover:bg-white/5 transition-colors">
              <div>
            ...
            <Link href="/dashboard/payslips" className="flex items-center justify-between p-3 rounded-xl border border-border hover:bg-white/5 transition-colors">
              <div>
