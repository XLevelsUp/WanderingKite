...
export async function updateMediaRecord(id: string, input: MediaRecordFormData) {
  ...
  revalidatePath('/media-tracker');
  revalidatePath(`/media-tracker/${id}`);
}
...
export async function bulkDeleteMediaRecords(ids: string[]) {
  ...
  revalidatePath('/media-tracker');
  revalidatePath('/media-tracker/map');
  revalidatePath('/media-tracker/editors');
...
export async function setStorageSlot(
  ...
  revalidatePath('/media-tracker');
  revalidatePath('/media-tracker/map');
  revalidatePath(`/media-tracker/${recordId}`);
}
...
export async function createStorageDevice(input: StorageDeviceFormData) {
  ...
  revalidatePath('/media-tracker/devices');
}
...
export async function updateAssignment(
  ...
  revalidatePath('/media-tracker');
  revalidatePath('/media-tracker/editors');
  revalidatePath(`/media-tracker/${mediaRecordId}`);
