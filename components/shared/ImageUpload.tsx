      ...
      >
        ...
        {preview && !isUploading ? (
          <>
            ...
            {/* Success indicator */}
            {uploadState === 'success' && (
              <div className="absolute top-2 left-2 flex items-center gap-1 rounded-full bg-emerald-500/20 px-2 py-0.5 text-xs font-medium text-emerald-400 border border-emerald-500/30">
