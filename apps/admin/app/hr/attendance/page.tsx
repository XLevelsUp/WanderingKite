...
export default async function AttendancePage({
  ...
  const prevLink = `/hr/attendance?month=${prevDate.getMonth() + 1}&year=${prevDate.getFullYear()}`;
  const nextLink = `/hr/attendance?month=${nextDate.getMonth() + 1}&year=${nextDate.getFullYear()}`;
