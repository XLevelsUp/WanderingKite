        ...
        <div className="lg:col-span-2 space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Attach an image to this shoot gallery</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Gallery Images ({shoot.gallery_images?.length || 0})</CardTitle>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {shoot.gallery_images.map((img: any) => (
                    <div key={img.id} className="group relative aspect-square rounded-xl overflow-hidden bg-white/5 border border-white/10">
                      ...
                      <DeleteGalleryImageButton id={img.id} shootId={shoot.id} />
                      {img.alt_text && (
