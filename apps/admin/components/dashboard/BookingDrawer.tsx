                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {bookingData.client_id && (
                          <Button variant="ghost" className="h-6 px-2 text-xs text-amber-500 hover:text-amber-400 hover:bg-amber-500/10" onClick={() => router.push(`/clients/${bookingData.client_id}`)}>
                            View Profile &rarr;
                          </Button>
                        )}
                      </div>
