    ...
    <div className="p-4 md:p-8 space-y-6 max-w-3xl mx-auto">
      <style dangerouslySetInnerHTML={{ __html: `
        @media print {
          ...
          #invoice { position: absolute; left: 0; top: 0; width: 100%; margin: 0; padding: 0; }
        }
      `}} />
      ...
      <div
        id="invoice"
        className="bg-white text-gray-900 rounded-2xl overflow-hidden shadow-2xl print:shadow-none print:rounded-none border border-gray-100 print:w-full print:border-0 print:m-0"
      >
        {/* Header */}
