...
/**
 * Fallback while the (dashboard) layout itself resolves — auth check,
 * profile fetch, and reminders all await before the sidebar shell renders.
 * Without this, that fetch has no visible loading state at all (the nested
 * dashboard/loading.tsx only covers the page inside the shell, not the
