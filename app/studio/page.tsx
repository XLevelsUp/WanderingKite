...
import { Building2, Maximize, Lightbulb, Wifi, Shirt, Zap, Box, PanelsTopLeft } from 'lucide-react';
...
const facilities = [
    { icon: Maximize, title: 'AC Studio Space', description: 'Spacious studio with 14ft ceilings' },
    ...
    { icon: Shirt, title: 'Changing Room', description: 'Dedicated makeup and changing area' },
    { icon: Zap, title: 'Power Backup', description: 'Uninterrupted power supply for shoots' },
    { icon: Box, title: 'Infinity Wall', description: 'Professional cyclorama wall setup' },
    { icon: PanelsTopLeft, title: 'Movable Walls', description: 'Flexible custom backdrop solutions' },
];
