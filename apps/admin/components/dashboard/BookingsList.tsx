    ...
    return (
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2" onClick={e => e.stopPropagation()}>
          ...
          <Button variant="outline" onClick={(e) => { e.stopPropagation(); router.push(`/clients/${booking.client_id}`); }} className="text-amber-500 border-amber-500/20 hover:text-amber-400 hover:bg-amber-500/10 h-8 px-3 text-xs ml-2">
