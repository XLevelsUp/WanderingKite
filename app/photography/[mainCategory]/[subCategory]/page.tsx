...
const categoryData = {
    events: {
        ...
        subCategories: [
            { id: 'wedding', title: 'Wedding', description: 'Full-day coverage with premium editing' },
            { id: 'engagements', title: 'Engagements', description: 'Intimate pre-wedding sessions' },
            { id: 'birthdays', title: 'Birthdays', description: 'Birthday milestones & parties' },
        ]
    },
    portraits: {
        title: 'Portrait Sessions',
        subCategories: [
            { id: 'family', title: 'Family', description: 'Studio & outdoor family portrait sessions' },
            { id: 'maternity', title: 'Maternity', description: 'Elegant maternity & expecting mother shoots' },
            { id: 'baby-shoots', title: 'Baby Shoots', description: 'Safe, gentle newborn photography' },
        ]
    },
    corporate: {
        title: 'Corporate & Brand',
        subCategories: [
            { id: 'product', title: 'Product', description: 'E-commerce & catalogue product photography' },
            { id: 'cinematic-videos', title: 'Cinematic Videos', description: 'Brand films & corporate video' },
            { id: 'social-media', title: 'Social Media Content', description: 'Platform-ready reels & posts' },
            { id: 'model-shoots', title: 'Model Shoots', description: 'Fashion & model portfolio sessions' },
            { id: 'headshots', title: 'Headshots', description: 'Professional headshots for teams' },
        ]
    },
    commercial: {
        title: 'Commercial Productions',
        subCategories: [
            { id: 'ads', title: 'Ads', description: 'High-concept advertisement productions' },
            { id: 'music-videos', title: 'Music Videos', description: 'Full-production music videos' },
            { id: 'short-films', title: 'Short Films', description: 'Narrative short film production' },
        ]
    }
};
