...
import { getBlogPosts } from '@/actions/blog-admin';
                    ...
                    <TableCell>
                      <div className="flex items-center justify-end gap-1">
                        <Button asChild variant="ghost" size="icon" title="View live">
                          {/* Public blog post lives on apps/marketing now — a
                              separate deployment, so this is an external link
                              (plain <a>, not next/link's <Link>) built from
                              NEXT_PUBLIC_MARKETING_URL rather than a relative
                              in-app route. */}
                          <a
